...
function generate() {
    keywords = getRandomKeywords(count.value);
}
</script>
...
<div class="md:full flex flex-col p-3 border m-3">
  ...
  <div class="flex justify-center">
    <button class="border py-2 px-3 mb-2 hover:bg-purple-300 bg-purple-200 text-purple-800 border-purple-800" on:click={generate}>
      Generate
    </button>
  </div>
</div>